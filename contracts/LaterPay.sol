...
/**
 * @title LaterPay
 * @dev Deferred payment system contract
 */
contract LaterPay is Ownable, ReentrancyGuard {
    using SafeERC20 for IERC20;

    IERC20 public immutable paymentToken; // TestUSDT token address
    ...
    // Admin addresses that can execute withdrawals
     ...
     *         Tokens remain in user's wallet until executePayment() is called.
     ...
     * @param approvalId Index of the approval
     * @return PaymentApproval struct
     */
     ...
     * @param user Address of the user
     * @return Array of PaymentApproval structs
     */
